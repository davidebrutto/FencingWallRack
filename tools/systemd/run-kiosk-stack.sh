...
case "${KIOSK_DISPLAY_PROFILE}" in
  ...
  sottopedana|SOTTOPEDANA|underfloor|UNDERFLOOR)
    ...
    KIOSK_UNDERFLOOR_LEFT_B_GEOMETRY="${KIOSK_UNDERFLOOR_LEFT_B_GEOMETRY:-30,326,1344,96}"
    KIOSK_UNDERFLOOR_RIGHT_A_GEOMETRY="${KIOSK_UNDERFLOOR_RIGHT_A_GEOMETRY:-30,622,1344,96}"
    KIOSK_UNDERFLOOR_RIGHT_B_GEOMETRY="${KIOSK_UNDERFLOOR_RIGHT_B_GEOMETRY:-30,918,1344,96}"
    ;;
  *)
