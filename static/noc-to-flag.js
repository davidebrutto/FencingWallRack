(function () {
  const NOC_TO_FLAG = {
    AFG: 'af', AHO: 'cw', AIN: 'ain', ALB: 'al', ALG: 'dz', AND: 'ad', ANG: 'ao', ANT: 'ag', ARG: 'ar', ARM: 'am', ARU: 'aw',
    ...
    CUR: 'cw', CUW: 'cw', CYP: 'cy', CZE: 'cz', DEN: 'dk', DJI: 'dj', DMA: 'dm', DOM: 'do', ECU: 'ec', EGY: 'eg', EOR: 'olympic_flag', ERI: 'er', ESA: 'sv',
